...
%\setromanfont[BoldFont=WenQuanYi Micro Hei]{FZSongS-Extended}
%\setromanfont[BoldFont=DejaVu Sans]{DejaVu Serif}
%\setmonofont{WenQuanYi Zen Hei Mono}

% 设置中文字体
\setCJKmainfont[BoldFont=WenQuanYi Micro Hei]{AR PL SungtiL GB}
...
\author{\textbf{\savedauthor}\thanks{本书基于 CC-BY-SA 4.0 (Commons Creative Attribution-Share Alike 4.0) 许可发布。本书使用 Markdown 书写，源文件：\url{https://github.com/beijinggug/gnome3-app-book/}，欢迎大家提出宝贵的意见和建议，以帮助此书更加完善，方便更多中国爱好 GNOME 的朋友。}}
