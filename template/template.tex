...
% 修改字体，粗体为文泉驿微米黑，普通文字为方正宋体（非自由，包含在WPS包内）
...
\author{\textbf{\savedauthor}\thanks{发布许可 Commons Creative Attribution-Share Alike 4.0。基于 Larrycaiyu 的 sdcamp 项目：\url{http://github.com/larrycai/sdcamp}}}
